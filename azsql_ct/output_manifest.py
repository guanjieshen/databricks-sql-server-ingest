...
def merge_add(
    ...
    *,
    ...
    for result in sync_results:
        ...
        soft_delete_column = result.get("soft_delete_column")
...
def _table_entry(
    ...
    if soft_delete and soft_delete_column and soft_delete_column != "_is_deleted":
        entry["soft_delete_column"] = soft_delete_column
